...
namespace MorseCode.RxMvvm.Samples.Calculator.ViewModels
{
    ...
    public class CalculatorViewModelWithNoSelection
    {
        ...
        public CalculatorViewModelWithNoSelection(bool supportsAsync)
        {
            ...
            this.selectedOperator = ObservablePropertyFactory.Instance.CreateProperty<Operator?>(Operator.Add);
