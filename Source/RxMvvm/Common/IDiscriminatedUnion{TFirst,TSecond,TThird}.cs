...
namespace MorseCode.RxMvvm.Common
{
    ...
    public interface IDiscriminatedUnion<out TFirst, out TSecond, out TThird>
    {
        /// <summary>
        ...
        /// </param>
        void Switch(Action<TFirst> first, Action<TSecond> second, Action<TThird> third);
        ...
        /// </returns>
        TResult Switch<TResult>(Func<TFirst, TResult> first, Func<TSecond, TResult> second, Func<TThird, TResult> third);
    }
}