...
namespace MorseCode.RxMvvm.Observable.Property.Internal
{
    ...
    [Serializable]
    internal class CancellableAsyncCalculatedPropertyWithContext<TContext, TFirst, TSecond, T> :
        ...
        ISerializable
    {
        ...
        private readonly Func<AsyncCalculationHelper, TContext, TFirst, TSecond, Task<T>> calculateValue;
                        ...
                        try
                        {
                            discriminatedUnion =
                                DiscriminatedUnion.First<object, T, Exception>(
                                    await calculateValue(helper, context, first, second));
                        }
                        catch (Exception e)
                        {
                            ...
                            async (s, t) =>
                                {
                                    ...
                                    resultSubject.OnNext(
                                        await
                                        calculate(
                                            new AsyncCalculationHelper(s, t), firstProperty.Value, secondProperty.Value));
                                });
                        d.Add(scheduledTask);
                                            ...
                                            async (s, t) =>
                                                {
                                                    try
                                                    {
                                                        ...
                                                        resultSubject.OnNext(
                                                            await
                                                            calculate(
                                                                new AsyncCalculationHelper(s, t), v.Item1, v.Item2));
                                                    }
                                                    catch (Exception e)
                                                    {
                                                        resultSubject.OnNext(
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CancellableAsyncCalculatedPropertyWithContext{TContext,TFirst,TSecond,T}"/> class from serialized data. 
        /// </summary>
        /// <param name="info">
        ...
        protected CancellableAsyncCalculatedPropertyWithContext(SerializationInfo info, StreamingContext context)
            ...
            : this(
                ...
                (Func<AsyncCalculationHelper, TContext, TFirst, TSecond, Task<T>>)info.GetValue("f", typeof(Func<AsyncCalculationHelper, TContext, TFirst, TSecond, Task<T>>)))
        {
        }
