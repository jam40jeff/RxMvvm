...
namespace MorseCode.RxMvvm.Observable.Property.Internal
{
    ...
    [Serializable]
    internal class CancellableAsyncCalculatedPropertyWithContext<TContext, TFirst, TSecond, TThird, TFourth, T> :
        ...
        ISerializable
    {
        ...
        private readonly Func<AsyncCalculationHelper, TContext, TFirst, TSecond, TThird, TFourth, Task<T>> calculateValue;
                                ...
                                try
                                {
                                    discriminatedUnion =
                                        DiscriminatedUnion.First<object, T, Exception>(
                                            await calculateValue(helper, context, first, second, third, fourth).ConfigureAwait(true));
                                }
                                catch (Exception e)
                                {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CancellableAsyncCalculatedPropertyWithContext{TContext,TFirst,TSecond,TThird,TFourth,T}"/> class from serialized data. 
        /// </summary>
        /// <param name="info">
        ...
        protected CancellableAsyncCalculatedPropertyWithContext(SerializationInfo info, StreamingContext context)
            ...
            : this(
                ...
                (Func<AsyncCalculationHelper, TContext, TFirst, TSecond, TThird, TFourth, Task<T>>)info.GetValue("f", typeof(Func<AsyncCalculationHelper, TContext, TFirst, TSecond, TThird, TFourth, Task<T>>)),
