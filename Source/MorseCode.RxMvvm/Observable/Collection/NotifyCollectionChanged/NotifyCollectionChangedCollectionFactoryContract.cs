...
namespace MorseCode.RxMvvm.Observable.Collection.NotifyCollectionChanged
{
    ...
    [ContractClassFor(typeof(INotifyCollectionChangedCollectionFactory))]
    internal abstract class NotifyCollectionChangedCollectionFactoryContract : INotifyCollectionChangedCollectionFactory
    {
        INotifyCollectionChangedCollection<T>
            INotifyCollectionChangedCollectionFactory.CreateNotifyCollectionChangedCollection<T>(
        ...
        IReadableNotifyCollectionChangedCollection<T>
            INotifyCollectionChangedCollectionFactory.CreateReadOnlyNotifyCollectionChangedCollection<T>(
