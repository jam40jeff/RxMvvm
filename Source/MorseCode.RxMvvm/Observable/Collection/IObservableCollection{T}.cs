...
namespace MorseCode.RxMvvm.Observable.Collection
{
    ...
    {
        /// <summary>
        /// Gets the number of elements contained in the observable collection.
        /// </summary>
        /// <returns>
        /// The number of elements contained in the observable collection.
        /// </returns>
        new int Count { get; }

        /// <summary>
        /// Gets or sets the element at the specified index in the observable collection.
        /// </summary>
        /// <param name="index">
        ...
        /// true
        /// </value>
        /// if <paramref name="item"/> is found in the observable collection, otherwise 
        /// <value>
        /// false
        /// </value>
        /// .
        ...
        /// true
        /// </value>
        /// if <paramref name="item"/> was successfully removed from the <see cref="T:System.Collections.Generic.ICollection`1"/>, otherwise 
        /// <value>
        /// false
        /// </value>
        ...
        /// false
        /// </value>
        /// if <paramref name="item"/> is not found in the original observable collection.
        /// </returns>
